...
public class MemoryLogManager implements LogManager {
    ...
    private static final Logger logger = Logger.getLogger( MemoryLogManager.class.getName() );
...
//        }
        loggersMap.clear();
        logger.info( "MemoryLogManager destroyed successfully." );
    }
